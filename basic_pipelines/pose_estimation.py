...
class GStreamerPoseEstimationApp(GStreamerApp):
    ...
    def get_pipeline_string(self):
        if (self.source_type == "rpi"):
            ...
            source_element = f"rtspsrc location=rtsp://192.168.144.25:8554/main.264 latency=0 buffer-mode=auto ! rtph265depay ! h265parse ! decodebin ! videoconvert ! autovideosink"
        else:  
